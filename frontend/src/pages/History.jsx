/**
 * pages/History.jsx
 * Audit trail chronologique d'un projet.
 */
...
const ACTION_ICON = {
  ...
  'email_template.updated':        '✏️',
  'email_template.deleted':        '🗑️',
}
  ...
  return (
    <div>
      <div style={{ marginBottom:'1.5rem' }}>
        ...
        <p style={{ marginTop:4 }}>{logs.length} event{logs.length !== 1 ? 's' : ''} recorded</p>
      </div>
          ...
          return (
            <div key={log.id} style={{ display:'flex', gap:'1rem', marginBottom:'0.5rem' }}>
              ...
              <div style={{
                ...
                <div style={{ fontSize:'0.7rem', color:'#3a3a40', marginTop:'0.25rem', fontFamily:"'Space Mono',monospace" }}>
